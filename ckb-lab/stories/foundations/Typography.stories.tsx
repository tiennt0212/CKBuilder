...
const TYPE_SCALE = [
  ...
  },
  {
    role: "Body / input",
    spec: "13.5px · 400–500",
    sample: "Standard interface text",
    style: { fontSize: 13.5, fontWeight: 400 },
  },
  {
    role: "Big amount",
    spec: "20px · 600 · tabular",
    sample: "1,000.00",
    style: { fontSize: 20, fontWeight: 600, fontVariantNumeric: "tabular-nums" },
  },
  {
    role: "Summary hero value",
    spec: "18px · 600 · primary",
    sample: "11,480.34 CKB",
    style: {
      fontSize: 18,
      fontWeight: 600,
      color: "var(--primary)",
  ...
  {
    role: "Group label (sidebar)",
    spec: "10.5px · 600 · CAPS · 0.07em",
  ...
  {
    role: "Code block",
    spec: "11.5px · mono · lh 1.65",
    sample: '"capacity": "0x174876e800"',
    style: {
      fontSize: 11.5,
      fontFamily: 'ui-monospace, "SF Mono", Menlo, monospace',
      lineHeight: 1.65,
